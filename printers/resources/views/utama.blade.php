...
<body>
    ...
    justify-content-between">
            <div class="logo">
                ...
                <h1><a href="index.html"><img src="assets/img/depan.png" alt="">CanPrints</a> </h1> <!-- Uncomment below if
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Cetak mencetak jadi satu</h1>
        ...
        <section id="produk" class="portfolio">
            <div class="container">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <div class="portfolio-links">
                                    <a href="assets/img/{{$p->gambar}}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="{{$p->nama.' '.$p->spesifikasi}}"><i class="bx bx-plus"></i>SHOW</a>
                                    |
                                    @if(Auth::check())
                                    <a href="" data-bs-toggle="modal" data-bs-target="#ModalTambahpembelian{{$p->id_printer}}" title="Pesan"><i class="bx bx-link"></i>BELI</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class=" modal fade" id="ModalTambahpembelian{{$p->id_printer}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body clearfix">
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Spesifikasi : {{$p->spesifikasi}}</p>
                                    ...
                                    <form action="/transaksi               /storeinput" method="post" class="form-floating">
                                        @csrf
                                        <input type="hidden" name="id_printer" value="{{$p->id_printer}}">
